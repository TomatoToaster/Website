  ...
  render() {
    return (
      <Fragment>
        ...
        <p>I'm a Software Engineer at Expensify working out of New York City. I graduated from Northeastern University (December 2018) with a degree in Computer Science/Mathematics.</p>
